...
evidence:
  flags:
    ...
    no_antarctic_construction_claim: true
    polar_program_review_required: true
...
floorplan:
  ...
  - height: 80
    ...
    y: 0
  - height: 80
    id: hardware_repair_lab
    label: hardware repair lab
    width: 120
    x: 420
    y: 0
  - height: 80
    id: networking_cyber_lab
    label: networking cyber lab
    width: 120
    x: 0
    y: 100
  - height: 80
    id: ai_cloud_studio
    label: ai cloud studio
    width: 120
    x: 140
    y: 100
  - height: 80
    id: career_portfolio_studio
    label: career portfolio studio
    width: 120
    x: 280
    y: 100
  - height: 80
  ...
  footprint: semi_permanent_hub
  label: "Conceptual only \u2014 not for construction"
  site_id: graham_land
power:
  backup: simulated polar power
