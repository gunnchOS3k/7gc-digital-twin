# Pre-registration — Paper I digital experiment

Frozen before treating any later held-out RF run as confirmatory.
...
Physical/held-out campaigns require a new pre-registration file. This file does not authorize those claims.
