#!/usr/bin/env python3
"""Verify E2E required files exist for 7gc-digital-twin."""
...
REQUIRED = [
    ...
    "Makefile",
    "results/e2e/gary_summary.md",
    "results/e2e/gary_export.json",
]
...
def main():
    ...
    if "End-to-End Research Artifact" not in readme:
        ...
        return 1
    print("PASS all required E2E artifacts for 7gc-digital-twin")
    return 0
